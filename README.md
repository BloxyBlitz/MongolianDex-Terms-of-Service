# MongolianDex Discord Bot - Terms of Service and Rules
Welcome to MongolianDex, the interactive countryball-catching and trading Discord bot! Before you start using MongolianDex, please carefully read and agree to the following Terms of Service and Rules. By using MongolianDex, you indicate your acceptance of these terms and your commitment to adhere to the rules.
...
- MongolianDex Team: the administrators of MongolianDex, possessing the "MongolianDex Team" role on the official Discord server. They have full control over the bot.
- Staff: Discord users holding a staff position on the official Discord server: Support, Moderator, MongolianDex Team, Trial staff.

1. Usage Agreement:
By using the MongolianDex Discord bot, you agree to follow these terms and rules. If you do not agree, please refrain from using the bot. Servers are responsible for their members and access may be revoked if deemed necessary.

2. MongolianDex Functionality:
MongolianDex allows you to catch, collect, and trade virtual countryballs, referred to as "collectibles" in these terms. The bot's primary purpose is entertainment, and it is not intended for any real-world transactions.
...
Exploits and Bugs
- If you discover a bug or exploit, you are required to report it to the MongolianDex Team immediately.
...
Staff Impersonation
- Impersonating MongolianDex staff, moderators, or administrators is strictly forbidden.
...
User Behaviour
- Users must treat all members of the MongolianDex community with respect. Engaging in harassment, bullying, or any form of abusive behavior is strictly prohibited.
...
Cross-trading refers to the act of trading MongolianDex collectibles, items, or assets for:
...
5. Privacy and Data
- MongolianDex collects minimal user data necessary for its functionality. We do not share this data with third parties.
- Do not share personal information, including passwords, addresses, or financial details, through the bot.

A more detailed privacy policy explaining what data is collected is available at the following link: https://github.com/BloxyBlitz/MongolianDex-Privacy-Policy
...
- Users must also comply with Discord's Terms of Service and Community Guidelines while using MongolianDex.
...
10. Availability
- MongolianDex is provided as-is. There are no guarantees that it will be available in the future, and its purpose or availability may be changed at any time.
- The MongolianDex Team reserves the right to remove or reset user data when necessary for maintenance, security, rule enforcement, or operational reasons.
- User-related data including backups is non-transferable between Discord accounts.
- The MongolianDex Team reserves the right to restrict usage of the bot or certain features to a user at any time, for any given reason.
...
By using MongolianDex, you agree to abide by these terms and rules. Failure to comply with these rules may result in warnings, temporary or permanent bans, or other appropriate actions determined by the bot administrators and moderators. Remember that MongolianDex is meant to be a fun and engaging experience for everyone. Enjoy catching and trading countryballs responsibly!
...
- Denied requests are permanent, unless specified otherwise by the MongolianDex Moderation Team. Do not send more requests afterwards.

The MongolianDex Moderation Team reserves the right to accept, deny, or decline to review appeals at its discretion. You may not be notified about the decision of the team. The availability of the appeals, including the Google Forms, is not guaranteed.
